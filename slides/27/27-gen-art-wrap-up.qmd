...
-   Peer eval 2 is due Friday at 5pm (form released today).

-   Course evaluations:

    -   +5 points on a HW (out of 100) if we get to 80% completion
...
::: columns
::: {.column width="33%"}
![](/student-work/images/thank-you-cards/thankyou-bharath03-a.png)
:::

::: {.column width="33%"}
![](/student-work/images/thank-you-cards/thankyou-KiwoonHong.png)
:::

::: {.column width="33%"}
![](/student-work/images/thank-you-cards/thankyou-Priyarsha31.png)
:::
:::

## Best ugly plot

![](/student-work/images/ugly-plots/ugly-plot-shalonwalter.png)
